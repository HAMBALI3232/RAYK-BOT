...
switch (command) {
 // menu 
 case 'menu': 
 m.reply(`*CARA PAKAI BOT PUSH KONTAK*
.push [text]

SEHAT SELALU😘`)    
break
case 'd': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '*d': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
...
break
case '_saveback_': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV*
*JANGAN LUPA SVB BOYY STORE REAL ( JAPOSTJAPOST )*
*SERING² LIAT SW YAA MAS*`)  
break
case '_saveback': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
...
case '*assalamualaikum*': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_assalamualaikum_': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_assalamualaikum': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '*_assalamualaikum': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_*assalamualaikum': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_*assalamualaikum*_': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '*_assalamualaikum_*': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
...
case '*waalaikumsalam*': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_waalaikumsalam_': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_waalaikumsalam': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '*_waalaikumsalam': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_*waalaikumsalam': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '_*waalaikumsalam*_': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
break
case '*_waalaikumsalam_*': 
 m.reply(`*DONE NOMOR MU SUDAH DI SV JANGAN LUPA SVB YA MAS SERING² LIHAT SW SAYA YA MAS*`)  
